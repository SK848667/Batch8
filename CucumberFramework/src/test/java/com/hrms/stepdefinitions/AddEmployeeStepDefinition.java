...
public class AddEmployeeStepDefinition extends CommonMethods {
    ...
    @When("add multiple employees from exel {string} sheet and verify they are added")
    public void add_multiple_employees_from_exel_sheet_and_verify_they_are_added(String sheetName) throws InterruptedException {
